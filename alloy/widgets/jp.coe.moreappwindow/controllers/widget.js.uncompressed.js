...
function Controller() {
    ...
    _.extend($, $.__views);
    var ANDROID_URL, ANDROID_YQL, API, IOS_URL, URL, args, callbackfunc, clickMore, clickRowCallback, fetchAndroidInfo, fetchIOSInfo, getItunesData, getItunesDataNew, refresh, refreshold, setLoadingView, windowFocus, _callback, _ref;
    args = arguments[0] || {};
    ...
    URL = API;
    _callback = null != (_ref = args.callback) ? _ref : function(e, d) {
    ...
    getItunesDataNew = function(data) {
        ...
        return null != (_ref1 = $.label) ? _ref1.text = "end" : void 0;
    };
    refresh = function() {
        var AppStoreClient;
    ...
    refreshold = function() {
        var client, url, _ref1;
        setLoadingView(true);
        null != (_ref1 = $.label) && (_ref1.text = "loading");
        $.table.data = [];
        url = IOS_URL;
        client = Ti.Network.createHTTPClient({
            ...
            onerror: function() {
                var _ref2;
                setLoadingView(false);
                return null != (_ref2 = $.label) ? _ref2.text = "error" : void 0;
            },
            timeout: 5e3
        });
        client.open("GET", url);
