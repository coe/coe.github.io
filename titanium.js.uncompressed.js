...
var require = {
	app: {
		analytics: false,
		copyright: "2014 by user",
		deployType: "production",
		description: "not specified",
		guid: "b8a20aa1-c47e-42ab-9208-93f19049c2d2",
		id: "jp.coe.appcatalog",
		name: "thapps",
		names: {},
		publisher: "user",
		url: "http://",
	...
	locales: ["af","am","ar","be","bg","ca","cs","da","de","el","en","es","et","fa","fi","fr","hi","hr","hu","in","it","iw","ja","ko","lt","lv","ms","nb","nl","pl","pt","rm","ro","ru","sk","sl","sr","sv","sw","th","tl","tr","uk","vi","zu"],
...
(function(global) {
	...
	function def(name, deps, rawDef) {
		...
		// scripts pending, so there's no way to know what the name is. :(
			...
			throw new Error("Unable to define anonymous module "+name);
		}
	}
